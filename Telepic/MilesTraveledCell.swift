...
class MilesTraveledCell: UITableViewCell {
    ...
    func updateMediaItems() {
        ...
        for mediaItem in mediaItems {
            FirebaseController.shared.fetchUser(uid: mediaItem.creatorID, completion: { (user) in
                ...
                self.updatedItems = updated.sorted { $0.milesTraveled > $1.milesTraveled }
            })
        }
    }
...
extension MilesTraveledCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
extension MilesTraveledCell: GreedoCollectionViewLayoutDataSource {
