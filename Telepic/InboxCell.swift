...
//        let date = Date(timeIntervalSince1970: inboxItem.timestamp)
//        daysRemainingLabel.text = date.dateString.uppercased()
...
//            switch indexPath.row {
//            case 1:
//                guard let itemID = inboxItem?.itemID else { return }
//                delegate?.segueToCommentsVC(withItemID: itemID)
//            default: break
//            }
//        } else if comments.count >= 2 {
//            switch indexPath.row {
